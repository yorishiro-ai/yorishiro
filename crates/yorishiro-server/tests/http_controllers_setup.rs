...
use yorishiro_server::max_tenants_env_lock::{LOCK as ENV_LOCK, set as set_max_tenants};
...
/// `MutexGuard` across an `.await` is sound here. See `yorishiro_server::max_tenants_env_lock`
