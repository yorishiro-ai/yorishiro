...
use yorishiro_server::http::middleware::rate_limit::RateLimiter;
...
async fn logs_a_warning_when_the_rate_limit_is_exceeded() {
    ...
    use yorishiro_server::http::middleware::rate_limit::enforce;
...
async fn apply_rate_limit_layer_enforces_the_limit_on_a_merged_router() {
    ...
    use axum::routing::get;
    use tower::ServiceExt;
    use yorishiro_server::http::middleware::rate_limit::apply_rate_limit_layer;
