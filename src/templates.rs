...
///
/// Each `source` is an inline JSON literal generated from the corresponding
/// `templates/*.json` file.  See `scripts/build.rs` or run
/// `cargo loco task seed_official_templates` after editing the JSON files.
