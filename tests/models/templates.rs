...
use yorishiro::models::_entities::{templates as entity_templates, tenants};
use yorishiro::models::templates;
...
async fn list_and_get_respect_tenant_and_community_visibility() {
    ...
    boot_request::<App, _, _>(|_request, ctx| async move {
        ...
        let private = entity_templates::ActiveModel {
        ...
        let community = entity_templates::ActiveModel {
        ...
        let hidden = entity_templates::ActiveModel {
            tenant_id: sea_orm::ActiveValue::Set(tenant_b.id),
