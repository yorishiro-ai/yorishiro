...
use yorishiro_core::workers::embedding_sync::WorkerClassResolver;
use yorishiro_hosted::HostedApp;
use yorishiro_hosted::services::worker_class_resolver::WorkerClassAssignmentResolver;
...
async fn resolver_returns_the_workspace_assignment_when_set_and_none_otherwise() {
    request_with_create_db::<HostedApp, _, _>(|_request, ctx| async move {
        ...
        yorishiro_hosted::models::worker_classes::set(
            &ctx.db,
            setup.workspace_id,
            yorishiro_core::workers::embedding_sync::WorkerClass::Official,
        )
        .await
        ...
        assert_eq!(
            after,
            Some(yorishiro_core::workers::embedding_sync::WorkerClass::Official),
