...
use yorishiro_core::services::embedding::WorkspaceEmbeddingResolver;
use yorishiro_hosted::HostedApp;
use yorishiro_hosted::services::embedding_resolver::EmbeddingKeyResolver;
...
async fn resolver_returns_the_workspace_assignment_when_set_and_none_otherwise() {
    request_with_create_db::<HostedApp, _, _>(|_request, ctx| async move {
        ...
        yorishiro_hosted::models::embedding_keys::set(
            &ctx.db,
            setup.workspace_id,
