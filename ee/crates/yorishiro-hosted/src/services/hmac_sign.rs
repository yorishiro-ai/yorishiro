...
//! (`services::oauth::state_token`) and the Stripe webhook signature (`controllers::stripe`).
//! Ported from master's `ee/crates/yorishiro-hosted/src/services/hmac_sign.rs`.
