...
/// membership in the key's tenant.
///
/// This is a **role-based** check (orthogonal to `ApiKeyScope`): a Member-role key can hold
/// `write` scope for content operations while still having no business reading billing data.
///
