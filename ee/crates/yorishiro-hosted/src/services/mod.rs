...
// The bind address and the empty-string fold are not edition-specific, so they live in
// `yorishiro-server` where the community binary can reach them too. Re-exported rather than
// re-implemented: two copies of "what counts as unset" is how the two drift apart.
