//! The template marketplace: `t`, `template_versions` and `identity_template_reviews`.
//!
...
/// The database does not enforce this: `template_versions` carries no RLS, matching `t`, so this WHERE clause is the enforcement, and dropping it publishes every tenant's unfinished work.
pub async fn list_versions(
    ...
    use crate::models::_entities::templates::Column as TemplateColumn;
    ...
    let rows = Entity::find()
        ...
        .join(sea_orm::JoinType::InnerJoin, Relation::Templates.def())
        .filter(
            Condition::any()
...
pub(crate) async fn is_visible(
    ...
    use crate::models::_entities::templates::{Column, Entity};
...
pub(crate) async fn insert_fork(
    ...
    use crate::models::_entities::templates::ActiveModel;
...
pub(crate) async fn update_visibility(
    ...
    // updated_at is not set here: templates::ActiveModel's before_save stamps it on
