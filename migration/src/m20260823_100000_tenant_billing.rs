...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        // yorishiro_app gets no GRANT at all here, matching identity_tenants: this table is
        // reached only through ctx.db (the migration-role connection), never a tenant-scoped
        // request connection. Enabling RLS anyway is defense in depth against a future grant
        // added without re-deriving this reasoning.
