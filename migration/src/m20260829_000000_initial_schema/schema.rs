...
pub(super) async fn up(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    create_foundation(manager).await?;
    create_identity(manager).await?;
    create_workspace(manager).await?;
    create_templates(manager).await?;
    create_schemas_entities(manager).await?;
    create_relations_and_billing(manager).await?;
    create_template_catalog(manager).await?;
    create_workspace_support(manager).await?;
    create_functions_and_credentials(manager).await?;
    Ok(())
}

async fn create_foundation(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    // tenant_tenants
...
async fn create_identity(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    // user_users
...
async fn create_workspace(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
...
async fn create_templates(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    // workspace_invites
    let table = Table::create()
...
async fn create_schemas_entities(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    // schema_schemas
    manager
        .create_table(
            Table::create()
...
async fn create_relations_and_billing(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    // entity_relations
    let table = Table::create()
...
async fn create_template_catalog(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    // template_versions
    manager
        .create_table(
            Table::create()
...
async fn create_workspace_support(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    // workspace_llm_keys
    let [created_at, updated_at] = helpers::timestamps(manager);
    manager
        .create_table(
...
async fn create_functions_and_credentials(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
...
pub(super) async fn down(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    drop_pre_table_objects(manager).await?;
    drop_tables(manager).await?;
    Ok(())
}

async fn drop_pre_table_objects(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
