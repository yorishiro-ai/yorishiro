...
mod m20260901_000002_add_reindex_embeddings_to_audit_log_action_check;
pub struct Migrator;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260901_000002_add_reindex_embeddings_to_audit_log_action_check::Migration),
