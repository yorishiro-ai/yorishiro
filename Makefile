...
entities:
	...
	DATABASE_URL=postgres://yorishiro:yorishiro@localhost:15433/yorishiro loco db migrate
	rm -f src/models/_entities/*.rs
	DATABASE_URL=postgres://yorishiro:yorishiro@localhost:15433/yorishiro loco db entities
